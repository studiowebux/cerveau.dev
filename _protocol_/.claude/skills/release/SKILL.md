...
10. **Update brain.** Write a `[progress]` note to mdplanner summarizing the release. Update the active milestone if all tasks are done. Update `local-dev.md` active milestone row if applicable.
